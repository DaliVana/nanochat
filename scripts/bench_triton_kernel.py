...
PROFILES = {
    ...
    "small-expand2":  dict(batch=16, seq_len=512,  d_model=256,  expand=2, d_state=64,  chunk_size=128, mimo_rank=1, ngroups=1),
    "small-expand4":  dict(batch=16, seq_len=512,  d_model=256,  expand=4, d_state=64,  chunk_size=128, mimo_rank=1, ngroups=1),
    "small-expand8":  dict(batch=16, seq_len=512,  d_model=256,  expand=8, d_state=64,  chunk_size=128, mimo_rank=1, ngroups=1),
    ...
    "medium-expand2": dict(batch=8, seq_len=2048, d_model=768,  expand=2, d_state=64,  chunk_size=64, mimo_rank=2, ngroups=1),
    "medium-expand4": dict(batch=8, seq_len=2048, d_model=768,  expand=4, d_state=64,  chunk_size=64, mimo_rank=2, ngroups=1),
    ...
    "large-ngroups2":  dict(batch=8, seq_len=4096, d_model=1280, expand=2, d_state=64,  chunk_size=128, mimo_rank=4, ngroups=2),
    "large-ngroups4":  dict(batch=8, seq_len=4096, d_model=1280, expand=2, d_state=64,  chunk_size=128, mimo_rank=4, ngroups=4),
    ...
    "xlarge-expand2": dict(batch=4, seq_len=8192, d_model=2560, expand=2, d_state=128, chunk_size=256, mimo_rank=4, ngroups=1),
    "xlarge-expand4": dict(batch=4, seq_len=8192, d_model=2560, expand=4, d_state=128, chunk_size=256, mimo_rank=4, ngroups=1),
}
