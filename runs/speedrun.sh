...
torchrun --standalone --nproc_per_node=8 -m scripts.base_train -- --depth=24 --mod-capacity=0.125 --device-batch-size=44 --target-param-data-ratio=18 --total-batch-size=720896 --run=$WANDB_RUN --warmdown-ratio=0.75 
