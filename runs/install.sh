...
torchrun --standalone --nproc_per_node=1 -m scripts.samba_train -- --run=compare_samba_ma_d12_V2 --model-tag=compare_samba_ma_d12 --depth=12 --max-seq-len=2048 --device-batch-size=4 --total-batch-size=131072 --eval-every=50 --eval-tokens=65536 --core-metric-every=1000 --sample-every=500 --save-every=-1 --mamba-d-state=64 --sliding-window=512 --num-iterations=100